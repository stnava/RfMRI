...
antsApplyTransforms -d 3 -i ~/data/wolk/fmri/template/BOLDaal.nii.gz -o aal.nii.gz -r ../MYtemplate.nii.gz -t ${nm}1Warp.nii.gz  -t ${nm}0GenericAffine.mat -n MultiLabel
